...
final class C0015p {
    ...
    static int m102a(int i, int i2) {
        return C0015p.m101a(i) + i2;
    }

    static int m103a(int i, Object obj) {
        if (obj == null) {
            return C0015p.m102a(i, 0);
        }
        if (!C0015p.m107a(obj)) {
            return C0015p.m102a(i, obj.hashCode());
        }
        int length = Array.getLength(obj);
        int i2 = 0;
        int i3 = i;
        while (i2 < length) {
            i = C0015p.m103a(i3, Array.get(obj, i2));
            i2++;
            i3 = i;
        }
        return i3;
    ...
    static <T extends Comparable<T>> int m104a(T t, T t2, C0016q c0016q) {
        int i = 0;
        if (t != null && t2 != null) {
        ...
        return C0016q.LAST == c0016q ? i * -1 : i;
    }
    ...
    static boolean m108a(Object[] objArr, Object[] objArr2) {
        ...
        for (int i = 0; i < objArr.length; i++) {
            if (!C0015p.m109b(objArr[i], objArr2[i])) {
                return false;
            }
        }
        return true;
    ...
    static boolean m109b(Object obj, Object obj2) {
        if (!C0015p.m107a(obj) && !C0015p.m107a(obj2)) {
