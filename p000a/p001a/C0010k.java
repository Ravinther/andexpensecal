...
final class C0010k {
    ...
    C0010k(C0000a c0000a, C0001b c0001b) {
        int i = 1;
        int i2 = 0;
        this.f43a = c0000a;
        m69a();
    ...
    private C0000a m68a(boolean z, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7) {
        this.f44b = z;
        ...
        m77g();
        m78h();
        return new C0000a(this.f53k, this.f54l, this.f55m, this.f56n, this.f57o, this.f58p, this.f59q);
    }
    ...
    private void m69a() {
        ...
        r2 = r8.f43a;
        r3 = 6;
        r3 = new p000a.p001a.C0004e[r3];
        r4 = p000a.p001a.C0004e.YEAR;
        r3[r1] = r4;
        r4 = p000a.p001a.C0004e.MONTH;
        r3[r0] = r4;
        r4 = p000a.p001a.C0004e.DAY;
        r3[r6] = r4;
        r4 = p000a.p001a.C0004e.HOUR;
        r3[r7] = r4;
        r4 = 4;
        r5 = p000a.p001a.C0004e.MINUTE;
        r3[r4] = r5;
        r4 = 5;
        r5 = p000a.p001a.C0004e.SECOND;
        r3[r4] = r5;
        r2 = r2.m24a(r3);
    ...
    L_0x0049:
        ...
        r4 = p000a.p001a.C0004e.HOUR;
        r3[r1] = r4;
        r4 = p000a.p001a.C0004e.MINUTE;
        r3[r0] = r4;
        r4 = p000a.p001a.C0004e.SECOND;
        r3[r6] = r4;
        r2 = r2.m29b(r3);
    ...
    L_0x008d:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: a.a.k.a():void");
    }
    ...
    private int m82l() {
        return C0000a.m4a(this.f53k, this.f54l).intValue();
    }

    private int m83m() {
        return this.f54l.intValue() > 1 ? C0000a.m4a(this.f53k, Integer.valueOf(this.f54l.intValue() - 1)).intValue() : C0000a.m4a(Integer.valueOf(this.f53k.intValue() - 1), Integer.valueOf(12)).intValue();
    }
    ...
    private void m87q() {
        ...
        } else if (C0001b.FirstDay == this.f45c) {
            this.f55m = Integer.valueOf(1);
            m80j();
        } else if (C0001b.LastDay == this.f45c) {
            this.f55m = Integer.valueOf(l);
        } else if (C0001b.Spillover == this.f45c) {
            this.f55m = Integer.valueOf(this.f55m.intValue() - l);
            m80j();
        }
    }

    C0000a m88a(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
    ...
    C0000a m89b(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
