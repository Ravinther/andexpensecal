...
class rw implements OnChildClickListener {
    final /* synthetic */ List f5236a;
    final /* synthetic */ ExpenseDetails f5237b;

    rw(ExpenseDetails expenseDetails, List list) {
        this.f5237b = expenseDetails;
        this.f5236a = list;
    }

    public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i2, long j) {
        Map map = (Map) ((List) this.f5236a.get(i)).get(i2);
        Bundle bundle = new Bundle();
        Intent intent = new Intent(this.f5237b.f3175C, ExpenseNewTransaction.class);
        ...
        this.f5237b.startActivityForResult(intent, 0);
        return false;
    }
}
