...
class fd implements OnItemClickListener {
    final /* synthetic */ ExpenseAccountActivities f4629a;

    fd(ExpenseAccountActivities expenseAccountActivities) {
        this.f4629a = expenseAccountActivities;
    }

    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        Map map = (Map) adapterView.getItemAtPosition(i);
        Bundle bundle = new Bundle();
        Intent intent = new Intent(this.f4629a.f2712h, ExpenseNewTransaction.class);
        String str = (String) map.get("paymentMethod");
        if (!(str.indexOf("/mi") == -1 && str.indexOf("/km") == -1)) {
            intent = new Intent(this.f4629a.f2712h, ExpenseMileageNewEdit.class);
        }
