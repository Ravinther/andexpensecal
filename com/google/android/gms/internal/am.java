...
public class am {
    public static int m5038a(String str) {
        byte[] bytes;
        try {
        ...
        return oi.m6343a(bytes, 0, bytes.length, 0);
    }

    static boolean m5039a(int i) {
        return Character.isLetter(i) && m5040a(UnicodeBlock.of(i));
    }

    private static boolean m5040a(UnicodeBlock unicodeBlock) {
    ...
    public static String[] m5041b(String str) {
        if (str == null) {
            return null;
        }
