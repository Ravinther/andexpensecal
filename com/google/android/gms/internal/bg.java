...
public abstract class bg extends Binder implements bf {
    public static bf m5133a(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        switch (i) {
            case C0607c.LoadingImageView_imageAspectRatio /*1*/:
                ...
                IBinder a = m5132a(C0583b.m4877a(parcel.readStrongBinder()), parcel.readInt() != 0 ? ay.CREATOR.m5072a(parcel) : null, parcel.readString(), ef.m5419a(parcel.readStrongBinder()), parcel.readInt());
